...
void ALARAVRAIL_SENSOR::resetTimer()
{
    timer = 0;
}
...
void ALARAVRAIL_SENSOR::linearConversion()
{
    /////linear conversions here, y = m*x + b
...
void ALARAVRAIL_SENSOR::exponentialMovingAverage()
{
...
void ALARAVRAIL_SENSOR::initializeLinReg(uint8_t arraySizeIn)
{
...
float ALARAVRAIL_SENSOR::linearRegressionLeastSquared_PID()
{
  uint32_t arrayIndexFirstValueLinReg = 0;
  uint32_t arrayWrapSizeLinReg = 0;
  uint32_t arrayMostRecentPositionLinReg = 0;
...
void ALARAVRAIL_SENSOR::accumulatedI_float()
{
